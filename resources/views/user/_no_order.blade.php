<div class="error-section flex justify-center mt-[60px]">
    ...
    <h3 class="text-30 mb-6 font-semibold " data-aos="fade-up" data-aos-duration="500">{{ __('Order list empty') }}</h3>
    <p class="text-paragraph mb-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="600">{{ __('Not Found typically means that the search of car you had previously added has been cleared.') }} <span class="text-black">{{ __('Thank you') }}</span></p>
