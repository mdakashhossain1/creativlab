 <div class="order-table border border-gray-200 rounded-lg overflow-hidden w-full overflow-x-auto">
     <div class="min-w-full divide-y divide-gray-200">
        ...
        <div class="error-section flex justify-center mt-[60px]">
            ...
            <h3 class="text-30 mb-6 font-semibold " data-aos="fade-up" data-aos-duration="500">{{ __('Transaction list empty') }}</h3>
            <p class="text-paragraph mb-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="600">{{ __('Not Found typically means that the search of transaction you had previously added has been cleared.') }} <span class="text-black">{{ __('Thank you') }}</span></p>
