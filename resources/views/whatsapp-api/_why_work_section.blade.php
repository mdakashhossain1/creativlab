    ...
    <div class="theme-container mx-auto">
        <div class="relative w-full rounded-[24px] overflow-hidden md:py-12 py-10 px-6 md:px-12"
            ...
            <div class="relative z-10">
                <h2 class="md:text-[34px] text-26 font-bold text-purple text-center mb-10">Why Work With CreativLab?</h2>

                <div class="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6">
                    @php
                        $points = [
                            [
                                'color' => '#25D366', 'bg' => 'bg-[#E8FFF0]',
                                'icon' => '<path d="M9 11l3 3L22 4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>',
                                'title' => 'Complete Setup Assistance',
                                'desc'  => 'We help businesses with API setup, verification, integration, and complete onboarding support.',
                            ],
                            [
                                'color' => '#794AFF', 'bg' => 'bg-[#EDE8FF]',
                                ...
                                'desc'  => 'Custom WhatsApp automation strategies tailored to your business goals and customer journey.',
                            ],
                            [
                                'color' => '#FF7E40', 'bg' => 'bg-[#FFF0E8]',
                                ...
                                'desc'  => 'Smart chatbot flows and campaigns built specifically for your business needs.',
                            ],
                            [
                                'color' => '#BA4AFF', 'bg' => 'bg-[#F5E8FF]',
                                ...
                                'desc'  => 'We help optimise campaigns, improve engagement, and scale customer communication effectively.',
                            ],
                        ];
                    @endphp
                    ...
                    <div class="bg-white/60 rounded-2xl p-5 border border-white">
                        ...
                        <h3 class="font-bold text-main-black text-sm mb-2">{{ $p['title'] }}</h3>
                        <p class="text-paragraph text-xs leading-5">{{ $p['desc'] }}</p>
                    </div>
                    @endforeach
                </div>
            </div>
