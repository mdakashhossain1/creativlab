                                        ...
                                        <div style="display:flex; align-items:center; gap:16px; flex-wrap:wrap;">
                                            ...
                                            <div style="flex:1; min-width:0;">
                                                ...
                                                @else
                                                    ...
                                                    <div style="display:flex; align-items:stretch; border:1.5px solid #d0d8ff; border-radius:8px; background:#f0f2ff;">
                                                        <p id="cronCmdText"
                                                           style="flex:1; margin:0; padding:11px 14px;
                                                                  font-family:'Courier New',Courier,monospace; font-size:11.5px;
                                                                  color:#1e3a5f !important; line-height:1.7;
