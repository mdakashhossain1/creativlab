                                        ...
                                        <div class="grid sm:grid-cols-2 gap-5">
                                            ...
                                            @endif
                                             ...
                                             <div class="col-span-full">
                                                 <button type="submit"
                                                     class="home-two-btn-bg py-3 bg-main-black border-main-black !flex before:hidden after:hidden hover:text-white w-full justify-center">
                                            ...
                                            <div class="col-span-full flex justify-center items-center gap-2">
                                             ...
                                             <div class="form-box">
                                                 <a href="{{ route('user.login-google') }}">
                                                     <div
                                                         class="home-two-btn-bg py-3 flex w-full before:hidden after:hidden border border-gray-200 bg-white hover:bg-gray-50 hover:border-purple">
                                                         <span>
