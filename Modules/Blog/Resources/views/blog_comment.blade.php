...
@section('title')
    <title>{{ __('Comment List') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Comment List') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Blog') }} >> {{ __('Comment List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Comment List') }}</h4>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a target="_blank" class="btn btn-success btn-sm"
                                                            href="{{ route('blog', $blog_comment?->blog?->slug) }}">{{ __('Click Here') }}</a>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.show-comment', $blog_comment->id) }}"
