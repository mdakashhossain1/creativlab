...
@section('title')
    <title>{{ __('Edit Blog') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Edit Blog') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Blog') }} >> {{ __('Edit Blog') }}</p>
@endsection
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Edit Blog') }}</h4>

                                                <a href="{{ route('admin.blog.index') }}" class="crancy-btn "><i
                                                        class="fa fa-list"></i> {{ __('Blog List') }}</a>
                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input class="crancy__item-input" type="text"
                                                                ...
                                                                value="{{ old('short_description', $blog_translate?->short_description) }}">
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <label class="crancy__item-label mb-0">{{ __('Description') }} *</label>
