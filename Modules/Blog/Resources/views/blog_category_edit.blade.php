...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Edit Category') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Blog') }} >> {{ __('Edit Category') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul class="d-flex">
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.blog-category.edit', ['blog_category' => $blog_category->id, 'lang_code' => $language->lang_code]) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Edit Category') }}</h4>

                                                <a href="{{ route('admin.blog-category.index') }}" class="crancy-btn "><i
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name"
                                                            id="name" value="{{ $cat_translate->name }}">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input class="crancy__item-input" type="text" name="slug"
                                                                id="slug" value="{{ $blog_category->slug }}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="crancy__item-switch">
                                                                    <input
                                                                        {{ $blog_category->status == 1 ? 'checked' : '' }}
