...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Blog Category') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Blog') }} >> {{ __('Blog Category') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Blog Category') }}</h4>
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($blog_categories as $index => $blog_category)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $blog_category->name }}
                                                        </h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ $blog_category->total_blog }}</h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.blog-category.edit', ['blog_category' => $blog_category->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-btn"><i class="fas fa-edit"></i>
                                                            {{ __('Edit') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $blog_category->id }})"
