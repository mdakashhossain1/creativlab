...
@section('title')
    <title>{{ __('Create Blog') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Create Blog') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Blog') }} >> {{ __('Create Blog') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Create Blog') }}</h4>
                                                    ...
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <select class="form-select crancy__item-input" name="category">
                                                            ...
                                                            @foreach ($blog_categories as $blog_category)
                                                                <option
                                                                    {{ $blog_category->id == old('category') ? 'selected' : '' }}
