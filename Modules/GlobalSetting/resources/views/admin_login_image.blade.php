...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Admin Login Page') }}</h3>
    <p class="crancy-header__text">{{ __('Website Setup') }} >> {{ __('Admin Login Page') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.admin-login-image-update') }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <h4 class="crancy-product-card__title">{{ __('Login Page') }}</h4>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="crancy__item-form--group mg-top-25 w-100">
                                                        <div
                                                            ...
                                                            <input type="file" class="btn-check" name="admin_login"
                                                                id="input-img1" autocomplete="off"
                                                                onchange="previewImage(event)">
                                                            <label class="crancy-image-video-upload__label"
                                                                for="input-img1">
                                                                <img id="view_img"
                                                                    src="{{ asset($general_setting->admin_login) }}">
