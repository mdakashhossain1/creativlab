...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Login Page') }}</h3>
    <p class="crancy-header__text">{{ __('Website Setup') }} >> {{ __('Login Page') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.login-image-update') }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="crancy__item-form--group mg-top-25 w-100">
                                                        <div
                                                            ...
                                                            <input type="file" class="btn-check" name="login_page_bg"
