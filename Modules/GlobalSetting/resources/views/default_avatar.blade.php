...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Default Avatar') }}</h3>
    <p class="crancy-header__text">{{ __('Website Setup') }} >> {{ __('Default Avatar') }}</p>
@endsection
                ...
                <div class="col-12">
                    <div class="crancy-body">
                        ...
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.default-avatar-update') }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <h4 class="crancy-product-card__title">{{ __('Default Avatar') }}</h4>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="crancy__item-form--group mg-top-25 w-100">
                                                        <div
                                                            ...
                                                            <input type="file" class="btn-check" name="default_avatar"
