...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Subscriber List') }}</h3>
    <p class="crancy-header__text">{{ __('Newsletter') }} >> {{ __('Subscriber List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch">
                                        <div class="crancy-header__form crancy-header__form--customer">
                                            <h4 class="crancy-product-card__title">{{ __('Subscriber List') }}</h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($newsletters as $index => $subscriber)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $subscriber->email }}
                                                        </h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ $subscriber->created_at->format('h:m A, d F Y') }}</h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a onclick="itemDeleteConfrimation({{ $subscriber->id }})"
