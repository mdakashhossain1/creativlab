...
@section('title')
    <title>{{ __('Our Partner') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Our Partner') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Content') }} >> {{ __('Our Partner') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Our Partner') }}</h4>

                                            <a href="{{ route('admin.partner.create') }}" class="crancy-btn "><span>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <a target="_blank"
                                                                href="{{ $partner->link }}">{{ __('Click Me') }}</a>
                                                        </h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.partner.edit', ['partner' => $partner->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-btn"><i class="fas fa-edit"></i>
                                                            {{ __('Edit') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $partner->id }})"
...
@push('js_section')
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ url('admin/partner/') }}' + "/" + id)
        }
    </script>
@endpush
