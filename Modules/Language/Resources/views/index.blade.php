...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Language List') }}</h3>
    <p class="crancy-header__text">{{ __('Dashboard') }} >> {{ __('Language List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Language List') }}</h4>
                                            ...
                                            @foreach ($languages as $index => $language)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $language->lang_name }}
                                                        </h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        @if ($language->is_default == 'Yes')
                                                            <span
                                                                class="badge bg-success text-white">{{ __('Enable') }}</span>
                                                        @else
                                                            <span
                                                                class="badge bg-danger text-white">{{ __('Disable') }}</span>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        ...
                                                        <a onclick="itemDeleteConfrimation({{ $language->id }})"
