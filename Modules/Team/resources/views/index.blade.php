...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Team Members') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Project') }} >> {{ __('Team Members') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Team Members') }}</h4>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><a
                                                                href="javascript:void(0)">{{ html_decode($team->translate->name) }}</a>
                                                        </h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ html_decode($team->translate->designation) }}</h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                ...
                                                                <li>
                                                                    <a onclick="itemDeleteConfrimation({{ $team->id }})"
