...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Terms and Conditions') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Pages') }} >> {{ __('Terms and Conditions') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.terms-conditions', ['lang_code' => $language->lang_code]) }}">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="crancy-body">
                        <!-- Dashboard Inner -->
                        <div class="crancy-dsinner">
                            <form action="{{ route('admin.update-terms-conditions') }}" method="POST"
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <label class="crancy__item-label">{{ __('Terms and Conditions') }} *
                                                            </label>
