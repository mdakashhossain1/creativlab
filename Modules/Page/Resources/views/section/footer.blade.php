...
@section('title')
    <title>{{ __('Footer Information') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Footer Information') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Section') }} >> {{ __('Footer Information') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.footer', ['lang_code' => $language->lang_code]) }}">
                                ...
                                <div class="row">
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <h4 class="crancy-product-card__title">{{ __('Footer Information') }}</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                @if (admin_lang() == request()->get('lang_code'))
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Phone') }} </label>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input class="crancy__item-input" type="text"
                                                                name="playstore" value="{{ $footer->playstore }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input class="crancy__item-input" type="text" name="appstore"
                                                                value="{{ $footer->appstore }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Copyright') }}
                                                            </label>
                                                            <input class="crancy__item-input" type="text"
                                                                name="copyright" value="{{ $footer->copyright }}">
                                                        </div>
                                                    </div>
                                                @endif
                                            ...
                                            @if (admin_lang() == request()->get('lang_code'))
                                                <h4 class="crancy-product-card__title mg-top-30">{{ __('Social Media') }}
                                                </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Linkedin') }}
                                                            </label>
                                                            <input class="crancy__item-input" type="text"
                                                                name="linkedin" value="{{ $footer->linkedin }}">
                                                        </div>
                                                    </div>

                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Instagram') }}
                                                            </label>
                                                            <input class="crancy__item-input" type="text"
