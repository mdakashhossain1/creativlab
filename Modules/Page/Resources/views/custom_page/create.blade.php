...
@section('title')
    <title>{{ __('Create Custom Page') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Create Custom Page') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Pages') }} >> {{ __('Create Custom Page') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Create Custom Page') }}</h4>
