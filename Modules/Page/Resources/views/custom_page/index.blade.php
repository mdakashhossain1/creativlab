...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Custom Page') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Pages') }} >> {{ __('Custom Page') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Custom Page') }}</h4>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><a
                                                                href="{{ route('custom-page', $custom_page->slug) }}">{{ $custom_page->translate->page_name }}</a>
                                                        </h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        ...
                                                        @else
                                                            <span
                                                                class="badge bg-success text-white">{{ __('Inactive') }}</span>
                                                        @endif
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.custom-page.edit', ['custom_page' => $custom_page->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-btn"><i class="fas fa-edit"></i>
                                                            {{ __('Edit') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $custom_page->id }})"
