...
@section('title')
    <title>{{ __('Edit Custom Page') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Edit Custom Page') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Pages') }} >> {{ __('Edit Custom Page') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.custom-page.edit', ['custom_page' => $custom_page->id, 'lang_code' => $language->lang_code]) }}">
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Edit Custom Page') }}</h4>

                                                <a href="{{ route('admin.custom-page.index') }}" class="crancy-btn "><i
                                                        class="fa fa-list"></i> {{ __('Custom Page List') }}</a>
                                            </div>
                                            ...
                                            <div class="row mg-top-30">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('Page Name') }} * </label>
                                                        <input class="crancy__item-input" type="text" name="page_name"
                                                            id="page_name" value="{{ $translate->page_name }}">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input class="crancy__item-input" type="text" name="slug"
                                                                id="slug" value="{{ $custom_page->slug }}">
                                                        </div>
                                                    </div>
                                                @endif
                                                        ...
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="crancy__item-switch">
                                                                    <input {{ $custom_page->status == 1 ? 'checked' : '' }}
