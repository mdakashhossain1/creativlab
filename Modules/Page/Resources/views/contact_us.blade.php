...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Contact Us') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Pages') }} >> {{ __('Contact Us') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.contact-us', ['lang_code' => $language->lang_code]) }}">
                                        ...
                                        <div class="crancy-product-card">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="title"
                                                            id="title" value="{{ $translate->title ?? $contact_us->title }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <label class="crancy__item-label">{{ __('Description') }} *
                                                            </label>
                                                        ...
                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box" name="description" id="description">{{ $translate->description ?? $contact_us->description }}</textarea>
                                                    </div>
                                                </div>

                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('Address') }} * </label>
                                                        <input class="crancy__item-input" type="text" name="address"
                                                            id="address" value="{{ $translate->address ?? $contact_us->address }}">
                                                    </div>
                                                </div>
                                                ...
                                                @if (admin_lang() == request()->get('lang_code'))
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Email') }} *
                                                            </label>
                                                            <input class="crancy__item-input" type="email" name="email"
                                                                id="email" value="{{ $contact_us->email }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Email') }}
                                                                ({{ __('Optional') }}) </label>
                                                            <input class="crancy__item-input" type="email2" name="email2"
                                                                id="email2" value="{{ $contact_us->email2 }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Phone') }} *
                                                            </label>
                                                            <input class="crancy__item-input" type="text" name="phone"
                                                                id="phone" value="{{ $contact_us->phone }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label class="crancy__item-label">{{ __('Phone') }}
                                                                ({{ __('Optional') }}) </label>
                                                            <input class="crancy__item-input" type="text" name="phone2"
                                                                id="phone2" value="{{ $contact_us->phone2 }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            <label
                                                                class="crancy__item-label">{{ __('Google Embed Map Link') }}
                                                                * </label>
