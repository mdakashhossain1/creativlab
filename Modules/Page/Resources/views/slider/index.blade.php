...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Slider List') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Frontend') }} >> {{ __('Slider List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Slider List') }}</h4>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ @$slider->translate->title }}</h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ @$slider->created_at->format('d M Y') }}</h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                ...
                                                                <li>
                                                                    <a onclick="itemDeleteConfrimation({{ $slider->id }})"
