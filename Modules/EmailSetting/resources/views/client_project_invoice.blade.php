                                        ...
                                        <div class="crancy-customer-filter">
                                            <div class="crancy-customer-filter__single crancy-customer-filter__single--csearch">
                                                <div class="crancy-header__form crancy-header__form--customer">
                                                    <h4 class="crancy-product-card__title">{{ __('Dynamic Keywords') }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <tbody class="crancy-table__body">
                                                    @php
                                                        $keywords = [
                                                            ...
                                                            ['key' => '{{paid_date}}',         'label' => 'Date Payment Was Made'],
                                                            ['key' => '{{project_name}}',      'label' => 'Project Name'],
                                                            ['key' => '{{project_title}}',     'label' => 'Project Title'],
                                                            ['key' => '{{installment_info}}',  'label' => 'Installment Info (e.g. Payment 2 of 5)'],
                                                            ['key' => '{{payment_method}}',    'label' => 'Payment Method'],
                                                            ['key' => '{{transaction_id}}',    'label' => 'Transaction / Reference ID'],
                                                            ['key' => '{{base_amount}}',       'label' => 'Base Amount (before GST)'],
                                                            ['key' => '{{gst_amount}}',        'label' => 'GST Amount'],
                                                            ['key' => '{{total_amount}}',      'label' => 'Total Amount Paid'],
                                                            ['key' => '{{payment_breakdown}}', 'label' => 'Full Payment Breakdown Table (auto-generated)'],
                                                        ];
                                                    @endphp
                                                        ...
                                                        <tr class="{{ $i % 2 === 0 ? 'odd' : 'even' }}">
                                                            <td class="crancy-table__column-2 crancy-table__data-2">
                                                                <h4 class="crancy-table__product-title">
                                                                    @php $display = $kw['key']; @endphp
                                                                    {{ $display }}
                                                                </h4>
                                                            </td>
                                                            <td class="crancy-table__column-2 crancy-table__data-2">
                                                                <h4 class="crancy-table__product-title">{{ __($kw['label']) }}</h4>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input crancy__item-textarea summernote"
                                                                  name="description">{{ $template_item->description }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
