                                                ...
                                                <tbody class="crancy-table__body">
                                                    @php
                                                        $keywords = [
                                                            ...
                                                            ['key' => '{{total_price}}',   'label' => 'Total Project Price'],
                                                            ['key' => '{{payment_type}}',  'label' => 'Payment Type (Split / Monthly)'],
                                                            ['key' => '{{start_date}}',    'label' => 'Project Start Date'],
                                                            ['key' => '{{end_date}}',      'label' => 'Project End Date'],
                                                            ['key' => '{{dashboard_url}}', 'label' => 'Link to User Project Dashboard'],
                                                        ];
                                                    @endphp
                                                    @foreach($keywords as $i => $kw)
                                                        <tr class="{{ $i % 2 === 0 ? 'odd' : 'even' }}">
                                                            <td class="crancy-table__column-2 crancy-table__data-2">
                                                                <h4 class="crancy-table__product-title">{{ $kw['key'] }}</h4>
                                                            </td>
                                                            <td class="crancy-table__column-2 crancy-table__data-2">
