                                                ...
                                                <tbody class="crancy-table__body">
                                                    @php
                                                        $keywords = [
                                                            ...
                                                            ['key' => '{{amount}}',          'label' => 'Total Amount Paid'],
                                                            ['key' => '{{payment_method}}',  'label' => 'Payment Method'],
                                                            ['key' => '{{download_links}}',  'label' => 'Download Buttons (auto-generated per product)'],
                                                            ['key' => '{{dashboard_url}}',   'label' => 'User Dashboard Downloads URL'],
                                                        ];
                                                    @endphp
