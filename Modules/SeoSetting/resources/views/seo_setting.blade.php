...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('SEO Setup') }}</h3>
    <p class="crancy-header__text">{{ __('Dashboard') }} >> {{ __('SEO Setup') }}</p>
@endsection
                                        ...
                                        <div class="crancy-psidebar">
                                            ...
                                            <div class="list-group crancy-psidebar__list" id="list-tab" role="tablist">
                                                ...
                                                @foreach ($seo_setting as $index => $seo_item)
                                                    <a class="list-group-item {{ $index == 0 ? 'active' : '' }}"
                                                        data-bs-toggle="list" href="#id1{{ $seo_item->id }}" role="tab"
                                                ...
                                                <div class="tab-content" id="nav-tabContent">
                                                    ...
                                                    @foreach ($seo_setting as $index => $seo_item)
                                                        <div class="tab-pane fade {{ $index == 0 ? 'active show' : '' }}"
                                                            id="id1{{ $seo_item->id }}" role="tabpanel">
                                                            <form
                                                                action="{{ route('admin.update-seo-setting', $seo_item->id) }}"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="crancy__item-label">{{ __('SEO Title') }}
                                                                                                    </label>
                                                                                                    <input
                                                                                                        class="crancy__item-input"
                                                                                                        type="text"
                                                                                                        value="{{ $seo_item->seo_title }}"
                                                                                                        name="seo_title">
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-12">
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        class="crancy__item-label">{{ __('SEO Description') }}
                                                                                                    </label>
