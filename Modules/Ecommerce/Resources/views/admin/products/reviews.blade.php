...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Review List') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Reviews') }} >> {{ __('Review List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Review List') }}</h4>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><a
                                                                href="{{ route('admin.user-show', $review->user_id) }}">{{ html_decode($review->user?->name) }}</a>
                                                        </h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title"><a
                                                                href="{{ route('product.view', $review->product->slug) }}">{{ Str::limit($review?->product?->translate->name, 25) }}</a>
                                                        </h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.review-detail', $review->id) }}"
