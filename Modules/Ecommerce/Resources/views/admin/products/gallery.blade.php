...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('Manage Product') }} >> {{ __('Product Gallery') }}</p>
@endsection
                                ...
                                <div class="col-12 mg-top-30">
                                    ...
                                    <div class="crancy-product-card">
                                        <div class="create_new_btn_inline_box">
                                            <h4 class="crancy-product-card__title">{{ __('Product') }} :
                                                {{ html_decode($product->translate->name) }}</h4>
                                        </div>

                                        <div class="row mg-top-30">
                                            <form id="dropzoneForm" method="post"
                                                action="{{ route('admin.product.uploadGallery', $product->id) }}"
                                                enctype="multipart/form-data" class="dropzone">
                                                @csrf
                                            </form>
                                            <div class="text-center">
                                                <button id="submit-all" class="crancy-btn mg-top-25"
                                                    type="submit">{{ __('Upload Images') }}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
@push('js_section')
    ...
    <script>
        ...
        function itemDeleteConfrimation(id) {
            $("#item_delect_confirmation").attr("action", '{{ url('admin/ecommerce/product/delete-gallery/') }}' + "/" +
                id)
        }
    </script>
