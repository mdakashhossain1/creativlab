...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Testimonial') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Section') }} >> {{ __('Testimonial') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Testimonial') }}</h4>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ $testimonial->translate->name }}</h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ $testimonial->translate->designation }}</h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.testimonial.edit', ['testimonial' => $testimonial->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-btn"><i class="fas fa-edit"></i>
                                                            {{ __('Edit') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $testimonial->id }})"
