...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Edit Testimonial') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Section') }} >> {{ __('Edit Testimonial') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.testimonial.edit', ['testimonial' => $testimonial->id, 'lang_code' => $language->lang_code]) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Edit Testimonial') }}</h4>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <input class="crancy__item-input" type="text" name="rating"
                                                                id="rating" value="{{ $testimonial->rating }}">
                                                        </div>
                                                    </div>
                                                </div>
