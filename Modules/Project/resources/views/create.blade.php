...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Create Project') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Project') }} >> {{ __('Create Project') }}</p>
@endsection
                                            ...
                                            <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="crancy__item-form--group w-100 h-100">
                                                                    ...
                                                                    <div
                                                                        class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                        <input type="file" class="btn-check"
                                                                            name="home_three_thumb_image" id="home_3_img"
                                                                            autocomplete="off"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="client_name"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="project_x"
                                                            id="project_x" value="{{ old('project_x') }}">
                                                    </div>
                                                </div>
                            ...
                            <div class="crancy-dsinner">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Author Information') }}</h4>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 mg-top-form-20">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                <label class="crancy__item-label">{{ __('Author Image') }}
                                                                    * </label>
                                                                <div
                                                                    class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    <input type="file" class="btn-check"
                                                                        name="author_image" id="author_images"
                                                                        autocomplete="off"
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('Author Designation') }}
                                                            *</label>
                                                        <input class="crancy__item-input" type="text"
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box" name="author_comment"
                                                            id="author_comment">{{ old('author_comment') }}</textarea>
                                                    </div>
                                                </div>
