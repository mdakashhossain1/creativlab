...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Brand List') }}</h3>
    <p class="crancy-header__text">{{ __('Dashboard') }} >> {{ __('Brand List') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('Brand List') }}</h4>
                                        ...
                                        <tbody class="crancy-table__body">
                                            @foreach ($brands as $index => $brand)
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.brand.edit', ['brand' => $brand->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-btn"><i class="fas fa-edit"></i>
                                                            {{ __('Edit') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $brand->id }})"
