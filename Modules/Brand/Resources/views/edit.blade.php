...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Edit Brand') }}</h3>
    <p class="crancy-header__text">{{ __('Dashboard') }} >> {{ __('Edit Brand') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.brand.edit', ['brand' => $brand->id, 'lang_code' => $language->lang_code]) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                <h4 class="crancy-product-card__title">{{ __('Edit Brand') }}</h4>
                                                <a href="{{ route('admin.brand.index') }}" class="crancy-btn "><i
                                                        class="fa fa-list"></i> {{ __('Brand List') }}</a>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name"
                                                            id="name" value="{{ $brand_translate->name }}">
                                                    </div>
                                                </div>
