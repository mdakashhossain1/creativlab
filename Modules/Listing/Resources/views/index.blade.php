...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('All Services') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Service') }} >> {{ __('All Service') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('All Services') }}</h4>
