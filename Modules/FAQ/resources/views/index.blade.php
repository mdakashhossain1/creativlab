...
@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('FAQ') }}</h3>
    <p class="crancy-header__text">{{ __('Manage Pages') }} >> {{ __('FAQ') }}</p>
@endsection
                                ...
                                <div class="crancy-customer-filter">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h4 class="crancy-product-card__title">{{ __('FAQ') }}</h4>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            {{ $faq->translate->question }}</h4>
                                                    </td>

                                                    <td
                                                        class="crancy-table__column-2 crancy-table__data-2 crancy-table__column-df  ">
                                                        <a href="{{ route('admin.faq.edit', ['faq' => $faq->id, 'lang_code' => admin_lang()]) }}"
                                                            class="crancy-btn"><i class="fas fa-edit"></i>
                                                            {{ __('Edit') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $faq->id }})"
