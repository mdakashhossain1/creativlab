...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('Manage Service') }} >> {{ __('Edit Category') }}</p>
@endsection
                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a
                                                            href="{{ route('admin.category.edit', ['category' => $category->id, 'lang_code' => $language->lang_code]) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="crancy-product-card">
                                            <div class="create_new_btn_inline_box">
                                                ...
                                                <a href="{{ route('admin.category.index') }}" class="crancy-btn "><i
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="name"
                                                            id="name" value="{{ $category_translate->name }}">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="crancy__item-form--group mg-top-form-20">
                                                            ...
                                                            <div
                                                                ...
                                                                <label class="crancy__item-switch">
                                                                    <input
                                                                        {{ $category->status == 'enable' ? 'checked' : '' }}
