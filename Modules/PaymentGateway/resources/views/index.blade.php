                                        ...
                                        <div class="crancy-psidebar">
                                            ...
                                            <div class="list-group crancy-psidebar__list" id="list-tab" role="tablist">
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id4"
                                                    ...
                                                    <h4 class="crancy-psidebar__title">{{ __('Flutterwave') }}</h4>
                                                </a>
                                                ...
                                                <a class="list-group-item" data-bs-toggle="list" href="#id5"
                                                    ...
                                                    <h4 class="crancy-psidebar__title">{{ __('Mollie') }}</h4>
                                                </a>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('Title') }}
                                                                                                    *</label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12">
                                                                                            <div
                                                                                                class="crancy__item-form--group mg-top-form-20">
                                                                                                <label
                                                                                                    class="crancy__item-label">{{ __('Mollie Key') }}
                                                                                                    * </label>
                                                                                                <input
                                                                                                    class="crancy__item-input"
                                                                                                    type="text"
