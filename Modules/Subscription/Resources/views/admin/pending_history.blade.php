...
@section('title')
    <title>{{ __('Pending History') }}</title>
@endsection

@section('body-header')
    <h3 class="crancy-header__title m-0">{{ __('Pending History') }}</h3>
    <p class="crancy-header__text">{{ __('Subscription Plan') }} >> {{ __('Pending History') }}</p>
@endsection
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title ">
                                                            ...
                                                            @else
                                                                <div class="badge bg-danger">{{ __('Unpaid') }}</div>
                                                            @endif
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">{{ $history->created_at->format('g:i A, d M Y') }}</h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.purchase-history-detail', $history->id) }}" class="crancy-btn"><i class="fas fa-eye"></i> {{ __('Detail') }}</a>

                                                        <a onclick="itemDeleteConfrimation({{ $history->id }})" href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal" class="crancy-btn delete_danger_btn"><i class="fas fa-trash"></i> {{ __('Delete') }}</a>
                                                    </td>
                                                </tr>
                                            @endforeach
